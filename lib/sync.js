...
// User-level local tasks — shared across all projects on this machine.
function localTasksDir() {
  return path.join(TASKLAB_DIR, 'tasks');
}

module.exports = { sync, hubTasksDir, hubLibDir, localTasksDir, readMeta, writeMeta, HUB_DIR, TASKLAB_DIR };
